			...
			<div class="">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<center>
							...
							<h4><span></span>فاکتور اخذ دستمزد</h4>
						</center>
						<div class="card">
							...
							<div class="card-block">
								<div class="row mb-2">
									<div class="col-sm-8 col-xs-6">
										...
										<span></span> تلفن: 0782156254 - 0731494651<br>
								...
								<table class="table table-bordered table-striped mb-2">
									<thead>
										<tr>
											<th><span></span>مورد</th>
											<th><span></span>قیمت</th>
										</tr>
									</thead>
									<tbody>
									@foreach($pension_info as $sell)
										<tr>
                      <td><span></span>{{$sell->item}}</td>
                      <td>{{$sell->cost}}</td>
										</tr>
										@endforeach
									</tbody>
                ...
                <a href="javascript:window.print()" class="btn btn-inverse waves-effect waves-light">
  							<button type="button" class="btn btn-info hidden-print label-left float-xs-right mr-0-5">
									...
									<a href="/pensions"><button type="button" class="btn-warning hidden-print" name="button" >برگشت</button></a>
							</div>
						</div>
					</div>
				</div>
