		...
		<div class="wrapper">
			...
			<div class="">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<center>
							...
							<h4><span></span>فاکتور پرداخت معاش کارمندان</h4>
						</center>
						<div class="card">
							...
							<div class="card-block">
								...
								@foreach($salaries as $salary)
									...
									<strong>معاش ماه: {{$salary->month}} - {{$salary->year}}</strong><br>
								</div>
								<table class="table table-bordered table-striped mb-2">
									<thead>
										<tr>
											<th><span></span>معاش</th>
											<th><span></span>پرداخت</th>
											<th><span></span>باقیات</th>
										</tr>
									</thead>
									<tbody>
										<tr>
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="text-xs-right">
											<div class="mb-0-5"><strong><span></span>معاش: {{$salary->salary}} افغانی</strong></div>
											<div class="mb-0-5"><span></span>  پرداخت: <span>{{$salary->paid}} افغانی</span>
										</div>
											<strong>
												باقیات:
                ...
                <a href="javascript:window.print()" class="btn btn-inverse waves-effect waves-light">
  							<button type="button" class="btn btn-info label-left float-xs-right mr-0-5 hidden-print">
