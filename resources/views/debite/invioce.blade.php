				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<center>
							...
							<h4><span></span>مدیریت مالی و محاسبه</h4>
							<h4><span></span>فاکتور پرداخت نقدی</h4>
						</center>
						<div class="card">
							...
							<div class="card-block">
								...
								@foreach($debites as $deposit)
									<strong><span></span> اسم مشتری: {{$deposit->name}}</strong><br>
									<strong><span></span>تخلص مشتری: {{$deposit->lastName}}</strong><br>
									<strong><span></span>آدرس مشتری: {{$deposit->address}}</strong><br>
								</div>
								<table class="table table-bordered table-striped mb-2">
									<thead>
										<tr>
											<th><span></span>اسم مشتری</th>
											<th><span></span>شماره تماس</th>
											<th><span></span>مبلغ</th>
										</tr>
									</thead>
									<tbody>
										<tr>
                      <td><span></span>{{$deposit->name}}</td>
                      <td><span></span>{{$deposit->supplier_phone}}</td>
                      <td><span></span>{{$deposit->paid}}</td>
										</tr>
										@endforeach
									</tbody>
								</table>
								<div class="row">
									<div class="col-lg-6">
										<div class="col-sm-4 col-xs-6">
											<div class="clearfix mb-0-25">
												<strong class="float-xs-left">امضا پرداخت کننده</strong>
											</div>
										</div>
									...
									<div class="col-lg-6">
										<div class="text-xs-right">
											<div class="mb-0-5"><strong><span></span>جمله رسید: {{$deposit->paid}} افغانی</strong></div>
											<!-- <div class="mb-0-5">  تخفیف: <span>0 افغانی</span> -->
										</div>
											<!-- <strong>
												قابل پرداخت:
												{{$deposit->id}}
