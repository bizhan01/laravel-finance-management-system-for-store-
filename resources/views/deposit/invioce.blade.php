				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<center>
							...
							<h4><span></span>فاکتور دریافت نقدی</h4>
						</center>
						<div class="card">
							...
							<div class="card-block">
								...
								@foreach($deposits as $deposit)
									<strong> اسم مشتری: {{$deposit->name}}</strong><br>
									<strong>تخلص مشتری: {{$deposit->lastName}}</strong><br>
									<strong>آدرس مشتری: {{$deposit->address}}</strong><br>
								</div>
